...
Drive the Doctrina spec-driven workflow for **Arbites**.
...
3. Close it: `doctrina close <id>` (verify → coverage → archive → validate) and
   resolve every `error:` before reporting the work done.
