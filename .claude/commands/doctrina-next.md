---
description: Show and act on the next recommended Doctrina workflow step
---

Decide the next step for **Arbites** from the framework's own signals.
...
Use the read-only commands first; never guess what is pending — let the CLI
report it.
