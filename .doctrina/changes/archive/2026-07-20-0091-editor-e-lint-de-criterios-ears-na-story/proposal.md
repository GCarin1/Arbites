...
- [x] Parser extrai `[EARS-n]` e indexa; lint acusa frase sem forma EARS e termo vago; story sem seção não gera warning — `backend/tests/test_requirements.py` (ou test_ears.py).
- [x] Templates no editor geram IDs sequenciais — build + revisão visual.
